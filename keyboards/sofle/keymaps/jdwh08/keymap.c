...
// TODO: SearchSelection from https://getreuer.info/posts/keyboards/macros/index.html
...
[_EXTND] = LAYOUT(
  ...
  QK_GESC,   KC_PRNT, KC_SRCHB,  KC_CLSE,     KC_RFSH,   KC_CBRC,                     KC_SNIP,    _______, KC_PRVWD,   KC_UP, KC_NXTWD,   KC_F12,
  _______,   KC_SAVE,  KC_SRCH,   KC_DEL,     KC_SLWD,   KC_SBRC,                     KC_FIND,    KC_ATAB,  KC_LEFT, KC_DOWN,  KC_RGHT,  _______,
    ...
    if (record->event.pressed) {
        switch (keycode) {
            ...
            case KC_SRCHB:
                ...
                SEND_STRING(SS_DELAY(50) SS_TAP(X_LGUI) SS_DELAY(100) "browser" SS_DELAY(500) SS_TAP(X_ENT) SS_DELAY(1000));
